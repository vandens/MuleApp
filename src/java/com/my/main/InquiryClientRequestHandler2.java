...
public class InquiryClientRequestHandler2 {
    ...
    public void InquiryClientService(InquiryAgentRequest RequestData){
        ...
        try {
            _clientRawRequest = Marshalling(RequestData,"com.my.Helper.serviceObject.InquiryAgentRequest"); 
            ...
            try {
                ...
                Logger.getLogger(InquiryClientRequestHandler2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String[] args){
            ...
            InquiryClientRequestHandler2 m = new InquiryClientRequestHandler2();
